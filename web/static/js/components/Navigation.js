...
const NAV_ITEMS = [
    ...
    { hash: '#/songs',    icon: 'songs',   label: '曲库' },
...
const ICONS = {
    ...
    songs: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',
    sing: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/></svg>',
...
export class TopNav extends BaseComponent {
    ...
    render() {
        ...
        brand.innerHTML = '<div class="logo">' + ICONS.songs + '</div>'
            + '<div class="brand-text">'
            + '<span class="brand-name">声乐评估系统</span>'
            + '<span class="brand-tag">专业版</span></div>';
    ...
    #navigate(hash) {
        if (this.router) this.router.navigate(hash);
